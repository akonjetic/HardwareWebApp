package hr.tvz.konjetic.hardwareapp.security;

import hr.tvz.konjetic.hardwareapp.security.service.JwtService;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private boolean isEndpointAllowingUnauthenticatedAccess(HttpServletRequest request) {
        ...
        return hr.tvz.konjetic.hardwareapp.security.SecurityConfiguration.UNAUTHENTICATED_ENDPOINTS
                .stream()
